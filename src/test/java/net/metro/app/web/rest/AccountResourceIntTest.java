...
import net.metro.app.config.Constants;

import net.metro.app.ProyCeroApp;
import net.metro.app.domain.Authority;
import net.metro.app.domain.User;
import net.metro.app.repository.AuthorityRepository;
import net.metro.app.repository.UserRepository;
import net.metro.app.security.AuthoritiesConstants;
import net.metro.app.service.MailService;
import net.metro.app.service.UserService;
import net.metro.app.service.dto.UserDTO;
import net.metro.app.web.rest.vm.KeyAndPasswordVM;
import net.metro.app.web.rest.vm.ManagedUserVM;
