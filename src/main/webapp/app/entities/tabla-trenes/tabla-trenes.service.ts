...
export class TablaTrenesService {
    ...
    create(tablaTrenes: TablaTrenes): Observable<TablaTrenes> {
    ...
    update(tablaTrenes: TablaTrenes): Observable<TablaTrenes> {
        const copy = this.convert(tablaTrenes);
    ...
    find(id: number): Observable<TablaTrenes> {
     ...
     */
    private convertItemFromServer(json: any): TablaTrenes {
        const entity: TablaTrenes = Object.assign(new TablaTrenes(), json);
        return entity;
    }
