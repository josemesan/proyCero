...
import net.metro.app.config.audit.AuditEventConverter;
import net.metro.app.domain.PersistentAuditEvent;
...
import static net.metro.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
